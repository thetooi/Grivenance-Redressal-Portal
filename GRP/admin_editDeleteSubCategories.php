  ...
  <body class="skin-blue">
    <div class="wrapper">
	  ...
	  ?>
		...
		<?php
			editDeleteSubCategory();		//function in include/adminFunctions.php
		?>
	...
	function deleteSubCategory(categoryID){
		...
		if (r == true) {
			window.location="admin/deleteSubCategory.php?categoryID="+categoryID;
		} else {
	  ...
	  $("#admin_sub_categories").addClass("active");
	  $("#admin_edit_sub_categories").addClass("active");
