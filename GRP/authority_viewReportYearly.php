  ...
  <body class="skin-blue">
    <div class="wrapper">
	  ...
	  ?>
		...
		<?php
			authority_yearlyReport();		//function in include/authorityFunctions.php
		?>
	...
	function printthis(){
		...
		//method to select the header and footer of letter head selected
		$.ajax({
			url:'ajax/templateForm.php',
	...
	function printFinal(id){
	
		
		var headerFooter = $('#header').val();
		var splitArray = headerFooter.split('$');
		
		
		var header = '<pre><h1 align="center">'+splitArray[0]+'</h1></pre>';
		var footer = '<footer align="center">'+splitArray[1]+'</footer>';
		var restore = document.body.innerHTML;
		document.body.innerHTML = header+document.getElementById(id).innerHTML+footer;
		window.print();
