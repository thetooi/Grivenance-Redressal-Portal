  ...
  <body class="skin-blue">
    <div class="wrapper">
	  ...
	  ?>
		...
		<?php
			editDeleteCategory();		//function in include/adminFunctions.php
		?>
	...
	function deleteCategory(categoryID){
		...
		if (r == true) {
			window.location="admin/deleteCategory.php?categoryID="+categoryID;
		} else {
	  ...
	  $("#admin_editCategories").addClass("active");
